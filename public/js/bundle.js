...
var SheetsApp = require('./components/SheetsApp.react.js');

React.render(
	React.createElement(SheetsApp, null),
	document.getElementById('app')
);

},{"./components/SheetsApp.react.js":3,"react":158}],2:[function(require,module,exports){
var React = require('react')
...
var SA_TableHeader = React.createClass({displayName: "SA_TableHeader",
	render: function(){
...
var SA_TableContent = React.createClass({displayName: "SA_TableContent",
	getCellsForRow: function(row){
		cellsForRow = Object.keys(row).map(function(key){
			return(React.createElement("td", null, row[key]))
		});
...
module.exports = SheetsApp = React.createClass({displayName: "SheetsApp",
	render: function(){
		return(
			React.createElement("div", {className: "sheets-app"}, 
				React.createElement(SA_Table, {data: json_data})
			)
		);
	}
});

},{"./SA_Table.react":2,"react":158}],4:[function(require,module,exports){
/**
